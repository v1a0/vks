...
#
# rand_useragent_list is COPIED FROM https://github.com/skratchdot/random-useragent/blob/master/useragent-data.json (2020)
...
class randheader:
	def get(upd):
		...
		rand_useragent = random.choice(rand_useragent_list)
		rand_useragent.update(upd)
